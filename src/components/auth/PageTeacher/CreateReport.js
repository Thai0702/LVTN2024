            ...
            <div className="card-body">
              <form onSubmit={handleAddReportRequest}>               
                ...
                <div className="form-group">
                  ...
                  <select className="form-control" onChange={(e) => setrequestOfProject(e.target.value)} value={requestOfProject}>
                ...
                <button className="btn btn-primary" type='submit' onClick={handleAddReportRequest}>Thêm</button>
              </form>
            </div>
          </div>
        </div>
